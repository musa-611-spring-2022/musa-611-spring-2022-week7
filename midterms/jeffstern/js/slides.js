...
function districtFilter(feature) {
  if (feature.properties.ppr_district === '8') return true;
  return false;
}

function facilityKingsessingFilter(feature) {
  if (feature.properties.public_name === 'Kingsessing Recreation Center') return true;
  return false;
}

function facilityPocketFilter(feature) {
  if (feature.properties.public_name === '60th and Baltimore Park') return true;
  return false;
}
...
const slides = [
  ...
  },
  {
    ...
    `,
    features: L.geoJson(facilities, { onEachFeature: stylePropertiesByDistrict }),
  },
  {
  ...
  },
  {
    ...
    `,
    features: L.geoJson(facilities, {
      filter: facilityKingsessingFilter,
      onEachFeature: stylePropertiesByEvents,
    }),
  },
  {
    ...
    `,
    features: L.geoJson(facilities, { onEachFeature: stylePropertiesByEvents }),
  },
];
