...
const slides = [
  ...
  {
    title: '1783',
    content: `<p>The beginning of the end for the Commonwealth came in 1772, with the first of three partitions which carved up Polish lands among the Russian, Prussian, and Austrian Empires.
  ...
  },
  {
    ...
    <p>Poland by name disappeared from the international map, but it was not without resistence. Many Horodetz Jews sided with Poland during the Polish "povstanya (rebellions).</p>
    <p>Economically and culturally Jews in the Horodetz shtetl during thsi time were living mostly as store-keepers, craftsmen and clergy.</p>.
    <p>Discontent rose when Horodetz became an important center because of its canal, and the Russian regime made Horodetz a military stonghold, stationing soldiers there starting 1876.`,
    bounds: [[10.546875,48.253941,36.298828,57.774518]],
    features: L.geoJSON(countries, {
